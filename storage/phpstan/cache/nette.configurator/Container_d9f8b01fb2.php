...
class Container_d9f8b01fb2 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d9f8b01fb2 $container)
			{
	...
	public function createServiceContainer(): Container_d9f8b01fb2
	{
		return $this;
	}
